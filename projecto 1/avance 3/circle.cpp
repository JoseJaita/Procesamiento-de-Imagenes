...
int main(int argc, char *argv[]){
    ...
    Size pattern_size(5,4);

    namedWindow("image", WINDOW_AUTOSIZE);
    VideoCapture video("others/videos/ps3_circle.avi");
    //VideoCapture video("others/videos/lifecam_circle.webm");
    ...
    if (arg == "-v"){
        ...
        while (1) {
            ...
            bool found = findCirclesGrid(gray, pattern_size, points2D);
